export default function Gap(){
    ...
    return (
        ...
        //     </div>
        // </section>
        <section className="py-6 px-6 sm:px-12 lg:px-10 bg-[#FFFFFF] font-sans">
        ...
        <div className="md:w-1/2">
                    <img src="colon.png" alt="" />
                     <h3 className="text-xl text-[#252525] md:2xl font-semibold">The gap between where you think you are and where you actually are — that's where most businesses lose customers.</h3>
                 </div>
