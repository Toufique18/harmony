        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between py-10">
           {/* left side */}
            <div className="w-1/2">
                ...
                <h1 className="font-bold text-2xl text-[#252525] md:text-4xl lg:text-5xl mt-6">Discover Where Your Brand, Culture, and Operations <span className="italic text-[#426DAB]">Are Out of Sync</span></h1>
