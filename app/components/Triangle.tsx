    ...
    <div className="relative flex items-center justify-center px-4 py-10">
      <div className="max-w-7xl w-full mx-auto">
        <div className="text-center">
          <button className="text-sm md:text-sm text-[#494949] rounded-full bg-white/15 backdrop-blur-sm border border-white/5 mb-3 md:mb-4 lg:mb-6 shadow-sm px-3 py-1">
            The Core Problem
          </button>
          ...
          <div className="mb-6 max-w-md mx-auto">
            <Link 
              href="/survey" 
              className="inline-block px-3 lg:px-5 py-2.5 rounded-lg border-none bg-[#F19526] text-white text-xs lg:text-lg font-sans font-semibold transition-all hover:scale-105 active:scale-95 shadow-[0_10px_15px_0_#F195264D]"
            >
