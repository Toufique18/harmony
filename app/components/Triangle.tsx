export default function Triangle(){
    ...
    return(
        ...
        <section className="relative w-full lg:py-20 py-10 px-6 sm:px-12 lg:px-24 bg-white bg-cover bg-center bg-no-repeat" style={{
        ...
        <div className="relative flex items-center justify-center  px-4 py-10">
          ...
          <div className="max-w-7xl w-full mx-auto">
            <div className="text-center">
              ...
              <h2 className="text-xl md:text-5xl font-bold text-[#252525] mb-4 tracking-tight">
              ...
              <div className="mb-6 max-w-md mx-auto">
                  ...
                  <button className="px-3 lg:px-5 py-2.5 rounded-lg border-none bg-[#F19526] text-white text-xs lg:text-lg font-semibold transition-all hover:scale-105 active:scale-95 shadow-[0_10px_15px_0_#F195264D]">Start Your Free Alignment Report</button>
